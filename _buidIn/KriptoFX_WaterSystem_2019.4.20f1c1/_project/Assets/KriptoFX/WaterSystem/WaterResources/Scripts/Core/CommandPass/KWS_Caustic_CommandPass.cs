...
namespace KWS
{
    public class KWS_Caustic_CommandPass
    {
        ...
        public void InitializeTextures()
        {
            ...
            _causticLod0.Alloc("causticLod0", size, size, 0, GraphicsFormat.R8_UNorm, useMipMap: true, autoGenerateMips: true, mipMapCount: 4);
            _causticLod1.Alloc("causticLod1", size, size, 0, GraphicsFormat.R8_UNorm, useMipMap: true, autoGenerateMips: true, mipMapCount: 4);
        ...
        public void InitializeMaterials()
        {
            ...
            {
                _causticDecalMaterial = KWS_CoreUtils.CreateMaterial(ShaderNames.CausticDecalShaderName);
        ...
        void DrawCausticDecal(Camera cam, CommandBuffer cmd, Transform camT)
        {
            var camPos = camT.position;
            var camDir = camT.forward;
            ...
            if (_waterInstance.UseCausticDispersion)
            {
                ...
                {
                    dispersionStrength = Mathf.Lerp(dispersionStrength * 0.5f, dispersionStrength * 2, _waterInstance.CausticTextureSize / 1024f);
            ...
            KWS_SPR_CoreUtils.SetRenderTarget(cmd, _colorBuffer, GetCameraRTHandleViewPortSize(cam), ClearFlag.None, Color.clear);
