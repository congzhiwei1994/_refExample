...
public class UVPreview
{
    ...
    public UVPreview(string checkerBoardPath, string boardLinePath)
    {
        //==============================================================================================//
        m_CheckerBoardMaterial = new Material(EditorGUIUtility.Load(checkerBoardPath) as Shader);
        m_CheckerBoardMaterial.hideFlags = HideFlags.HideAndDontSave;

        m_BoardLineMaterial = new Material(EditorGUIUtility.Load(boardLinePath) as Shader);
    ...
    public UVPreview(Shader CheckerBoard, Shader BoardLine)
    {
        //==============================================================================================//
        m_CheckerBoardMaterial = new Material(CheckerBoard);
        //m_CheckerBoardMaterial = new Material(Shader.Find("Hidden/Internal/GUI/CheckerBoard"));
        m_CheckerBoardMaterial.hideFlags = HideFlags.HideAndDontSave;

        //m_BoardLineMaterial = new Material(Shader.Find("Hidden/Internal/GUI/BoardLine"));
        m_BoardLineMaterial = new Material(BoardLine);
        m_BoardLineMaterial.hideFlags = HideFlags.HideAndDontSave;
    ...
    private void DrawCheckerBoard(Rect rect)
    {
        ...
        m_CheckerBoardMaterial.SetColor("_ColorA", new Color(0.6f, 0.6f, 0.6f));//2020-12-05
        m_CheckerBoardMaterial.SetColor("_ColorB", new Color(0.55f, 0.55f, 0.55f));//2020-12-05
        //该矩阵用于实际绘制棋盘格
