...
Shader "Good/WaterFall/WaterFall-WhiteC-2T"
{
	Properties
	{
		...
		_VCOffset("VC-Offset", Range( 0 , 12)) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction ( VertexInput v  )
			{
				...
				float2 uv_ShapeTex = v.ase_texcoord.xy * _ShapeTex_ST.xy + _ShapeTex_ST.zw;
				float4 tex2DNode5 = SAMPLE_TEXTURE2D_LOD( _ShapeTex, sampler_ShapeTex, uv_ShapeTex, 0.0 );
				...
				#endif
				float3 vertexValue = ( _VCOffset * float4( v.ase_normal , 0.0 ) * Height59 * v.ase_color.a * tex2DNode5 ).rgb;
				#ifdef ASE_ABSOLUTE_VERTEX_POS
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 lerpResult8 = lerp( DarkColor88 , _LightColor , HeightShade79);
				float3 temp_cast_0 = (IN.ase_color.a).xxx;
				float3 temp_cast_1 = (IN.ase_color.a).xxx;
				float3 gammaToLinear92 = FastSRGBToLinear( temp_cast_1 );
				float4 lerpResult87 = lerp( DarkColor88 , ( float4( 0,0,0,0 ) + lerpResult8 ) , float4( gammaToLinear92 , 0.0 ));
				
				float smoothstepResult14 = smoothstep( _Min , _Max , temp_output_11_0);
				float Height59 = smoothstepResult14;
				float2 uv_ShapeTex = IN.ase_texcoord3.xy * _ShapeTex_ST.xy + _ShapeTex_ST.zw;
				float4 tex2DNode5 = SAMPLE_TEXTURE2D( _ShapeTex, sampler_ShapeTex, uv_ShapeTex );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = lerpResult87.rgb;
				float Alpha = saturate( ( Height59 * tex2DNode5 * step( saturate( ( 1.0 - IN.ase_color.a ) ) , temp_output_11_0 ) ) ).r;
...
/*ASEBEGIN
Version=18400
156;608;1651;470;-1175.641;355.8699;1.672122;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;23;-1873.67,673.9279;Inherit;False;Property;_Speed;Speed;8;0;Create;True;0;0;False;0;False;1;1.38;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;15;544.9172,650.2362;Inherit;False;Property;_Max;Max;6;0;Create;True;0;0;False;0;False;1;0.913;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.VertexColorNode;83;550.3992,1240.278;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.OneMinusNode;84;776.8824,1338.453;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;61;1236.607,1137.171;Inherit;False;953.6577;699.2188;Comment;6;5;25;24;60;26;66;;1,1,1,1;0;0
Node;AmplifyShaderEditor.SaturateNode;85;976.9682,1337.207;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;5;1235.136,1611.237;Inherit;True;Property;_ShapeTex;ShapeTex;0;0;Create;True;0;0;False;0;False;-1;None;590d2692cc859d74e8c5c0f2c1242d5f;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.StepOpNode;81;1508.942,875.6698;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;67;1738.481,213.6161;Inherit;False;59;Height;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;63;703.2084,-112.429;Inherit;False;762.5404;460.4319;Comment;5;8;12;13;62;88;;1,1,1,1;0;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;71;2162.261,232.2832;Inherit;False;3;3;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.VertexColorNode;66;1330.48,1441.225;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.NormalVertexDataNode;24;1327.961,1289.033;Inherit;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;60;1657.913,1484.672;Inherit;False;59;Height;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;26;1286.607,1187.171;Inherit;False;Property;_VCOffset;VC-Offset;9;0;Create;True;0;0;False;0;False;1;4.18;0;12;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;43;1804.036,-244.4518;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.VertexColorNode;86;2118.583,-65.55089;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;68;2252.62,340.5052;Inherit;False;Property;_AlphaClip;AlphaClip;10;0;Create;True;0;0;False;0;False;0.3;0.001;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;79;1523.151,633.4641;Inherit;False;HeightShade;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;78;465.4198,883.7224;Inherit;False;Property;_MinS;MinS;5;0;Create;True;0;0;False;0;False;0.05719795;0.331;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;89;2261.83,-296.4697;Inherit;False;88;DarkColor;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;25;2010.405,1213.767;Inherit;False;5;5;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;77;467.5222,977.6716;Inherit;False;Property;_MaxS;MaxS;7;0;Create;True;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;8;1268.231,-21.92012;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;88;996.8971,-57.25682;Inherit;False;DarkColor;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;13;753.2084,136.0029;Inherit;False;Property;_LightColor;LightColor;3;0;Create;True;0;0;False;0;False;1,1,1,0;0.8760235,0.9622641,0.961445,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;62;1003.717,199.0912;Inherit;False;79;HeightShade;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;12;739.4428,-68.82899;Inherit;False;Property;_DarkColor;DarkColor;2;0;Create;True;0;0;False;0;False;0.372864,0.5002386,0.5377358,0;0.6323425,0.8571008,0.9245283,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;82;679.5771,1113.584;Inherit;False;Constant;_Float0;Float 0;11;0;Create;True;0;0;False;0;False;0.1496346;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;87;2711.197,-230.0428;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SaturateNode;76;2344.603,225.3929;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GammaToLinearNode;92;2408.759,-29.04892;Inherit;False;0;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=3EEBD1CC6E16132072D03822E4A8F0CFFA8EAB44