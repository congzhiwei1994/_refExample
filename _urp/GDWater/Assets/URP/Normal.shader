	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction ( VertexInput v  )
			{
				...
				float2 texCoord2_g1 = v.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 vertexToFrag10_g1 = ( ( texCoord2_g1 * (unity_LightmapST).xy ) + (unity_LightmapST).zw );
				o.ase_texcoord3.xy = vertexToFrag10_g1;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 ShadowCoords = float4( 0, 0, 0, 0 );
					...
					#endif
				#endif
				float2 vertexToFrag10_g1 = IN.ase_texcoord3.xy;
				...
				float4 staticSwitch15_g1 = float4(34.49324,2.2,0,0);
				#else
				float4 staticSwitch15_g1 = float4(2,2.2,0,0);
				#endif
				#ifdef UNITY_LIGHTMAP_FULL_HDR
				float4 staticSwitch13_g1 = float4(0,0,0,0);
				#else
				float4 staticSwitch13_g1 = staticSwitch15_g1;
				#endif
				float3 decodeLightMap6_g1 = DecodeLightmap(localSampleLightmapHD11_g1,staticSwitch13_g1);
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = decodeLightMap6_g1;
				float Alpha = 1;
...
/*ASEBEGIN
Version=18400
1945;599;1526;1007;803.994;569.5414;1;True;False
Node;AmplifyShaderEditor.WorldNormalVector;5;-425.0306,-90.39374;Inherit;False;True;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.AbsOpNode;6;-215.0306,-90.39374;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SamplerNode;7;-393.994,-359.5414;Inherit;True;Global;_TextureSample0;Texture Sample 0;0;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;8;-349.994,108.4586;Inherit;False;FetchLightmapValue;0;;1;43de3d4ae59f645418fdd020d1b8e78e;0;0;1;FLOAT3;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;-31,-45;Float;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;3;Dev/WNormal;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;0;Hidden/InternalErrorShader;0;0;Standard;22;Surface;0;  Blend;0;Two Sided;1;Cast Shadows;1;  Use Shadow Threshold;0;Receive Shadows;1;GPU Instancing;1;LOD CrossFade;0;Built-in Fog;0;Meta Pass;0;DOTS Instancing;0;Extra Pre Pass;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position,InvertActionOnDeselection;1;0;5;False;True;True;True;False;False;;True;0
WireConnection;6;0;5;0
WireConnection;1;2;8;0
ASEEND*/
//CHKSM=FBF30CB89DCF121B66A2F7BA0C0E6B4717885144