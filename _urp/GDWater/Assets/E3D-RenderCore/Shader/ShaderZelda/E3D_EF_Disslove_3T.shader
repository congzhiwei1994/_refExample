	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				half mulTime5 = _TimeParameters.x * 0.4;
				half2 panner24 = ( mulTime5 * _UVFlowSpeed + float2( 0,0 ));
				half2 texCoord4 = IN.ase_texcoord3.xy * temp_cast_0 + panner24;
				half4 tex2DNode46 = tex2D( _DissLoveMap, texCoord4 );
				half2 temp_cast_1 = (_UVTiling).xx;
				half mulTime28 = _TimeParameters.x * 0.4;
				half2 panner27 = ( mulTime28 * ( _UVFlowSpeed * 3.0 ) + float2( 0,0 ));
				half2 texCoord25 = IN.ase_texcoord3.xy * temp_cast_1 + panner27;
				half4 temp_output_7_0 = ( tex2DNode46 * tex2D( _MaskMap, texCoord25 ) * _Opacity );
				half4 texCoord42 = IN.ase_texcoord3;
				texCoord42.xy = IN.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				half temp_output_22_0 = ( texCoord42.z + _DissInstensity );
				...
				half4 temp_output_45_0 = ( tex2D( _DissLoveMap, uv_DissLoveMap ).r * tex2D( _TextureSample0, uv_TextureSample0 ) );
				half4 temp_output_10_0 = step( temp_cast_2 , temp_output_45_0 );
				half4 temp_cast_3 = (temp_output_22_0).xxxx;
				half4 temp_output_14_0 = step( temp_cast_3 , ( temp_output_45_0 + _Thickness ) );
				half4 temp_cast_4 = (temp_output_22_0).xxxx;
				
				float4 temp_cast_6 = (1.0).xxxx;
				half4 temp_cast_7 = (temp_output_22_0).xxxx;
				half4 clampResult36 = clamp( temp_output_7_0 , float4( 0.2205882,0.2205882,0.2205882,0 ) , float4( 1,1,1,0 ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				half4 texCoord42 = IN.ase_texcoord2;
				texCoord42.xy = IN.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				half temp_output_22_0 = ( texCoord42.z + _DissInstensity );
				half4 temp_cast_1 = (temp_output_22_0).xxxx;
				...
				half4 temp_output_45_0 = ( tex2D( _DissLoveMap, uv_DissLoveMap ).r * tex2D( _TextureSample0, uv_TextureSample0 ) );
				half4 temp_output_14_0 = step( temp_cast_1 , ( temp_output_45_0 + _Thickness ) );
				half2 temp_cast_2 = (_UVTiling).xx;
				half mulTime5 = _TimeParameters.x * 0.4;
				half2 panner24 = ( mulTime5 * _UVFlowSpeed + float2( 0,0 ));
				half2 texCoord4 = IN.ase_texcoord2.xy * temp_cast_2 + panner24;
				half4 tex2DNode46 = tex2D( _DissLoveMap, texCoord4 );
				half2 temp_cast_3 = (_UVTiling).xx;
				half mulTime28 = _TimeParameters.x * 0.4;
				half2 panner27 = ( mulTime28 * ( _UVFlowSpeed * 3.0 ) + float2( 0,0 ));
				half2 texCoord25 = IN.ase_texcoord2.xy * temp_cast_3 + panner27;
				half4 temp_output_7_0 = ( tex2DNode46 * tex2D( _MaskMap, texCoord25 ) * _Opacity );
				half4 clampResult36 = clamp( temp_output_7_0 , float4( 0.2205882,0.2205882,0.2205882,0 ) , float4( 1,1,1,0 ) );
...
/*ASEBEGIN
Version=18400
-107;548;1524;467;-196.7717;-648.4869;1.338175;True;False
Node;AmplifyShaderEditor.Vector2Node;1;-1673.945,132.8393;Float;False;Property;_UVFlowSpeed;UVFlowSpeed;0;0;Create;True;0;0;False;0;False;0,-0.3;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;40;-1661.327,407.9665;Float;False;Constant;_Float1;Float 1;10;0;Create;True;0;0;False;0;False;3;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;9;-1382.393,1057.125;Inherit;True;Property;_DissLoveMap;DissLoveMap;4;0;Create;True;0;0;False;0;False;-1;723d609500fd514409fabd10ed79ed0e;ef7d9f8f093e28f46b80f3b211446a92;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;44;-1365.702,1318.045;Inherit;True;Property;_TextureSample0;Texture Sample 0;0;0;Create;True;0;0;False;0;False;-1;None;c840f1c81c65fcd4787e396f1de744a3;True;0;False;white;Auto;False;Instance;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;34;-1250.035,307.3705;Float;False;Property;_UVTiling;UV-Tiling;2;0;Create;True;0;0;False;0;False;0;0;0;4;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;13;-1315.565,1557.645;Float;False;Property;_Thickness;Thickness  ;7;0;Create;True;0;0;False;0;False;0.3574858;0.2;0;0.2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;23;-1129.716,936.9177;Float;False;Property;_DissInstensity;Diss-Instensity;6;0;Create;True;0;0;False;0;False;0.468391;0.255;0.01;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;35;-485.4724,601.6407;Float;False;Property;_Opacity;Opacity;9;0;Create;True;0;0;False;0;False;2.843909;5;0;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;8;-523.5349,377.0211;Inherit;True;Property;_MaskMap;MaskMap;3;0;Create;True;0;0;False;0;False;-1;None;e5e4f8d6f0dfeca45a8fcc8174dfa252;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;30;201.3798,1439.482;Float;False;Constant;_Float0;Float 0;8;0;Create;True;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;29;524.4994,1212.31;Float;True;Property;_DissAlpha;Diss-Alpha;5;0;Create;True;0;0;False;0;False;1;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.Vector2Node;26;-1267.978,443.8551;Float;False;Constant;_Vector1;Vector 1;0;0;Create;True;0;0;False;0;False;0,-0.9;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.ColorNode;19;-154.4691,918.8425;Float;False;Property;_BaseColor;BaseColor;1;1;[HDR];Create;True;0;0;False;0;False;0.3574827,0.5000507,0.8382353,0;0.9852941,0.8413972,0.6592777,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;17;-162.6417,1341.432;Float;False;Property;_EdgeColor;EdgeColor;8;1;[HDR];Create;True;0;0;False;0;False;0.4411765,0.8843812,1,0;2.983001,2.421494,1.579236,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=0ADA11EE00AF830BD879C4621B585E91D1BB3F56