Shader "JZPAJ/Character_AO_Tone_Alphamap"
{
    Properties
    {
		...
		_Min_GGX_Roughness("粗糙度最小值", Range(0,1)) = 0.04
		_Max_GGX_Roughness("粗糙度最大值", Range(0,1)) = 1.0
...
//				half3 normalTS = UnpackNormalRG_Optimize(normalCol.rg, 1.0, 1.0);
...
//				float3 local_784 = lightColor * finalRNoL;
...
//
//				float3 local_797 = My_F_Schlick(local_795, VoH);
//				// F_Schlick
//
...
//				float3 local_955 = EnvironmentBRDFApprox(roughnessRange, NoV, local_795);
//
...
//				float3 local_1124 = local_1123 * env_tone + 0;
//
//				// 边缘光
