Shader "JZPAJ/Character_Burn_SSS_AO_CA(Rim+AdjustInner)"
{
    Properties
    {
		...
		[NoScaleOffset]_BurnMap("_BurnMap", 2D) = "black" {}
		[NoScaleOffset]_BurnNoiseMap("_BurnNoiseMap", 2D) = "black" {}

		_SSS_Factor("_SSS_Factor", Float) = 1.0

		_Noise_Speed01("_Noise_Speed01(Vector2)", Vector) = (0, 0, 1, 1)
		_Noise_Speed02("_Noise_Speed02(Vector2)", Vector) = (0, 0, 1, 1)
		_Noise_Density01("_Noise_Density01", Float) = 0.0
		_Noise_Density02("_Noise_Density02", Float) = 0.0
		_Tortuosity_Intensity01("_Tortuosity_Intensity01", Float) = 0.0
		_Tortuosity_Intensity02("_Tortuosity_Intensity02", Float) = 0.0
		_Mask_Intensity("_Mask_Intensity", Float) = 0.0
		_Noise_Intensity02("_Noise_Intensity02", Float) = 0.0
		_Burn_Amount("_Burn_Amount", Float) = 0.0
		_Burn_Line_Width("_Burn_Line_Width", Float) = 0.0
		_Burn_Color01("_Burn_Color01", Color) = (1, 1, 1, 1)
		_Burn_Color02("_Burn_Color02", Color) = (1, 1, 1, 1)
		_Burn_Color03("_Burn_Color03", Color) = (1, 1, 1, 1)
		_AlphaAmount("_AlphaAmount", Float) = 0.0
		_Black_Height("_Black_Height", Float) = 0.0
		_ColorUPAmount("_ColorUPAmount", Float) = 0.0
    ...
    SubShader
    {
		...
		Pass
		{
			...
			#define USE_SSS 
			#define USE_AO 
			#define USE_CHANGE_AMOUNT_RIM_AND_ADJUST_INNER  
			#define USE_BURN  
