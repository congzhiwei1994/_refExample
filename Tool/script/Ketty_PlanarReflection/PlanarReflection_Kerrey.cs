...
[ExecuteInEditMode]
public class PlanarReflection_Kerrey : MonoBehaviour {
    ...
    void HoldCameraSettings (Camera heplerCam) {
        heplerCam.depthTextureMode = DepthTextureMode.None;
    ...
    RenderTexture CreateTexture (Camera sourceCam) {
        ...
        RenderTexture rt = new RenderTexture (width, height, 0, formatRT);
